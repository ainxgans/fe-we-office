...
import {bookingSchema} from "../types/validationBooking.ts";
...
export default function BookOffice() {
    ...
    const [formData, setFormData] = useState({
        ...
        started_at: "",
        office_space_id: "",
        totalAmountWithoutUniqueCode: 0,
    })

    const [formErrors, setFormErrors] = useState<z.ZodIssue[]>([]);
    const [isLoading, setIsLoading] = useState(false)
    const [uniqueCode, setUniqueCode] = useState<number>(0)
    const [totalAmountWithoutUniqueCode, setTotalAmountWithoutUniqueCode] = useState<number>(0)
    ...
    useEffect(() => {
        apiClient
            .get(`/office/${slug}`)
            .then((response) => {
                console.log("Office data fetched", response.data.data);
                ...
                setTotalAmountWithoutUniqueCode(grandTotal);
    ...
    return (
        <>
            ...
            >
                ...
                <div
                    className="absolute w-full h-full bg-[linear-gradient(180deg,_rgba(0,0,0,0)_0%,#000000_91.83%)] z-10"/>
                <img
            ...
            >
                <div
                    className="flex flex-col shrink-0 w-[500px] h-fit rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div
                                className="flex items-center rounded-full border border-[#000929] px-5 gap-[10px] transition-all duration-300 focus-within:ring-2 focus-within:ring-[#0D903A]">
                                <img
                                ...
                                />
                                {formErrors.map((error) => error.path.includes("name") && (
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div
                                className="flex items-center rounded-full border border-[#000929] px-5 gap-[10px] transition-all duration-300 focus-within:ring-2 focus-within:ring-[#0D903A] overflow-hidden">
                                <img
                                ...
                                />
                                {formErrors.map((error) => error.path.includes("started_at") && (
                                    <p className="text-red-500">{error.message}</p>
                                ))}
                            </div>
                        </div>
                ...
                <div
                    className="flex flex-col shrink-0 w-[400px] h-fit rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <p className="font-bold text-[22px] leading-[33px] text-[#0D903A]">
                                Rp {totalAmountWithoutUniqueCode.toLocaleString('id', {
                    ...
                    >
                        <span>{isLoading ? "Wait a minute . . " : "Book now"}</span>
                    </button>
                </div>
            </form>
        </>
